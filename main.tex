...
% -----------------
\documentclass[
    pdfa,       % formato PDF/A, obbligatorio per l'archiviazione delle tesi di Polito
...
%\setcounter{tocdepth}{3}% TOC-numbering-depth (TOC=Table-Of-Content)
...
\input{sections/frontespizio/frontespizio.tex}
...
\input{sections/ack/acknowledgements.tex}
...
\input{sections/chapter2/stateoftheart.tex}

\chapter{Methodology}
\input{sections/chapter3/solution.tex}

\chapter{Experimental results}
\input{sections/chapter4/results.tex}

\chapter{Conclusions and future work}
\input{sections/chapter5/conclusions.tex}

\paginavuota

% print bibliography
\input{sections/biblio/bibliography.tex}
